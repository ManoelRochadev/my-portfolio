        ...
        <div className="flex items-center justify-between  border-gray-100 py-6 md:justify-start md:space-x-10">
          <div className="flex justify-start lg:w-0 lg:flex-1">
            <a href="#">
              ...
              <h1 className='text-2xl font-extrabold text-gray-400'>Manoel<span className='text-white'> Rocha</span></h1>
            </a>
          </div>
          
          <Popover.Group as="nav" className="hidden space-x-10 md:flex">
             <a href="#" className="text-base font-medium text-white hover:text-gray-300" >Sobre mim</a>
          ...
          <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0 gap-5">
            <a href="#" className="whitespace-nowrap text-white text-base flex font-medium text-whitehover:text-gray-900 flex-row">
